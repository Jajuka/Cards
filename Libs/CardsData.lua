...
CardsData.karCards =
{
	...
	[25] = { nCardId = 25, nNumber = 25, strCategory = "Creatures", strName = "Medusa", nQualityID = 2, nTop = 2, nRight = 3, nBottom = 2, nLeft = 5, strFlair = "", strSprite = "CardsSprites:025_Drifter" },
	...
	[85] = { nCardId = 85, nNumber = 85, strCategory = "Dominion", strName = "Kezrek Warbringer", nQualityID = 4, nTop = 4, nRight = 1, nBottom = 9, nLeft = 4, strFlair = "", strSprite = "CardsSprites:085_KezrekWarbringer" },
	...
	[99] = { nCardId = 99, nNumber = 99, strCategory = "Exiles", strName = "Avra Darkos", nQualityID = 4, nTop = 7, nRight = 7, nBottom = 1, nLeft = 3, strFlair = "", strSprite = "CardsSprites:099_AvraDarkos" },
...
CardsData.tCardsByQuality = {}

-- Table containing definitions for each opponent that can be challenged.
CardsData.karOpponents =
{
	{ nOpponentId =   1, nCreatureId = 46140, nDifficulty = 1, strName = "Melashi Soulclover" },
	{ nOpponentId =   2, nCreatureId = 46766, nDifficulty = 1, strName = "Naya Briarwood" },
	{ nOpponentId =   3, nCreatureId = 20018, nDifficulty = 2, strName = "Supervisor Wicksprout" },
	{ nOpponentId =   4, nCreatureId = 46159, nDifficulty = 2, strName = "Arwick Redleaf" },
	{ nOpponentId =   5, nCreatureId = 19720, nDifficulty = 3, strName = "Sera Melfield" },
	{ nOpponentId =   6, nCreatureId = 53245, nDifficulty = 3, strName = "Queen Myala Everstar" },
	{ nOpponentId =  11, nCreatureId = 21863, nDifficulty = 1, strName = "Krag Studrok" },
	{ nOpponentId =  12, nCreatureId = 02627, nDifficulty = 1, strName = "Ruck" },
	{ nOpponentId =  13, nCreatureId = 19754, nDifficulty = 2, strName = "Brewmaster Grok" },
	{ nOpponentId =  14, nCreatureId = 45674, nDifficulty = 2, strName = "Merchant Sandstone" },
	{ nOpponentId =  15, nCreatureId = 33911, nDifficulty = 3, strName = "Chef Theok" },
	{ nOpponentId =  16, nCreatureId = 16715, nDifficulty = 3, strName = "Sergeant Trogdan" },
	{ nOpponentId =  21, nCreatureId = 57071, nDifficulty = 1, strName = "Kit Brinny" },
	{ nOpponentId =  22, nCreatureId = 02371, nDifficulty = 1, strName = "Medic Grits" },
	{ nOpponentId =  23, nCreatureId = 47899, nDifficulty = 2, strName = "High Judge Bron Kellick" },
	{ nOpponentId =  24, nCreatureId = 46152, nDifficulty = 2, strName = "Chavin Fairchild" },
	{ nOpponentId =  25, nCreatureId = 21370, nDifficulty = 3, strName = "Deadeye Brightland" },
	{ nOpponentId =  26, nCreatureId = 46236, nDifficulty = 3, strName = "Warrant Officer Burke" },
	{ nOpponentId =  31, nCreatureId = 32708, nDifficulty = 1, strName = "Harrower Krimzon" },
	{ nOpponentId =  32, nCreatureId = 59527, nDifficulty = 1, strName = "Boris Shamara" },
	{ nOpponentId =  33, nCreatureId = 54363, nDifficulty = 2, strName = "Lenka Kholos" },
	{ nOpponentId =  34, nCreatureId = 34505, nDifficulty = 2, strName = "Anthropologist Liev" },
	{ nOpponentId =  35, nCreatureId = 24937, nDifficulty = 3, strName = "Victor Lazarin" },
	{ nOpponentId =  36, nCreatureId = 37913, nDifficulty = 3, strName = "Sergeant Dominik" },
	{ nOpponentId =  41, nCreatureId = 32852, nDifficulty = 1, strName = "Veronia Cazalon" },
	{ nOpponentId =  42, nCreatureId = 47306, nDifficulty = 1, strName = "Supervisor Sernelia" },
	{ nOpponentId =  43, nCreatureId = 40636, nDifficulty = 2, strName = "Malvolio Portius" },
	{ nOpponentId =  44, nCreatureId = 47310, nDifficulty = 2, strName = "Field Medic Lutton" },
	{ nOpponentId =  45, nCreatureId = 32857, nDifficulty = 3, strName = "Emperor Myrcalus" },
	{ nOpponentId =  46, nCreatureId = 56913, nDifficulty = 3, strName = "Lord Aluviel" },
	{ nOpponentId =  51, nCreatureId = 24418, nDifficulty = 1, strName = "Minion Togor" },
	{ nOpponentId =  52, nCreatureId = 47394, nDifficulty = 1, strName = "Doctor Zazz" },
	{ nOpponentId =  53, nCreatureId = 25378, nDifficulty = 2, strName = "Researcher Zum" },
	{ nOpponentId =  54, nCreatureId = 24208, nDifficulty = 2, strName = "Arachnologist Borango" },
	{ nOpponentId =  55, nCreatureId = 11484, nDifficulty = 3, strName = "Mondo Zax" },
	{ nOpponentId =  56, nCreatureId = 48778, nDifficulty = 3, strName = "Twilo Pim" },
	{ nOpponentId =  61, nCreatureId = 47913, nDifficulty = 1, strName = "Sergeant Jakaah" },
	{ nOpponentId =  62, nCreatureId = 26081, nDifficulty = 1, strName = "Kevo" },
	{ nOpponentId =  63, nCreatureId = 47550, nDifficulty = 2, strName = "Merchant Vezka" },
	{ nOpponentId =  64, nCreatureId = 25026, nDifficulty = 2, strName = "Huntress Kezzia" },
	{ nOpponentId =  65, nCreatureId = 24158, nDifficulty = 3, strName = "Kezrek Warbringer" },
	{ nOpponentId =  66, nCreatureId = 50589, nDifficulty = 3, strName = "Commando Toothbreaker" },
	{ nOpponentId =  71, nCreatureId = 52520, nDifficulty = 1, strName = "Scientist Trinix" },
	{ nOpponentId =  72, nCreatureId = 41097, nDifficulty = 1, strName = "Architect Cybene" },
	{ nOpponentId =  73, nCreatureId = 14630, nDifficulty = 2, strName = "Lieutenant Regulus" },
	{ nOpponentId =  74, nCreatureId = 47184, nDifficulty = 2, strName = "Captain Doxhertz" },
	{ nOpponentId =  75, nCreatureId = 41471, nDifficulty = 3, strName = "Axis Pheydra" },
	{ nOpponentId =  76, nCreatureId = 10399, nDifficulty = 3, strName = "Agent Lex" },
	{ nOpponentId =  81, nCreatureId = 24142, nDifficulty = 1, strName = "Bride Kamala" },
	{ nOpponentId =  82, nCreatureId = 02963, nDifficulty = 1, strName = "Pinny Bop" },
	{ nOpponentId =  83, nCreatureId = 24523, nDifficulty = 2, strName = "Laksmi the Dutiful" },
	{ nOpponentId =  84, nCreatureId = 42150, nDifficulty = 2, strName = "Qatichi" },
	{ nOpponentId =  85, nCreatureId = 25413, nDifficulty = 3, strName = "Young Migisi" },
	{ nOpponentId =  86, nCreatureId = 35638, nDifficulty = 3, strName = "Nandin" },
	{ nOpponentId =  91, nCreatureId = 04041, nDifficulty = 1, strName = "Dnal Trebor" },
	{ nOpponentId =  92, nCreatureId = 40695, nDifficulty = 1, strName = "Storehand Vandina" },
	{ nOpponentId =  93, nCreatureId = 23532, nDifficulty = 2, strName = "Captain Milo" },
	{ nOpponentId =  94, nCreatureId = 22455, nDifficulty = 2, strName = "Captain Tolben" },
	{ nOpponentId =  95, nCreatureId = 20052, nDifficulty = 3, strName = "Smoky Soka" },
	{ nOpponentId =  96, nCreatureId = 29360, nDifficulty = 3, strName = "Spigo" },
	{ nOpponentId = 101, nCreatureId = 20027, nDifficulty = 1, strName = "Grollo the Butcher" },
	{ nOpponentId = 102, nCreatureId = 26138, nDifficulty = 1, strName = "Protostar Employee" },
	{ nOpponentId = 103, nCreatureId = 22583, nDifficulty = 2, strName = "Blackfrost Agent" },
	{ nOpponentId = 104, nCreatureId = 13103, nDifficulty = 2, strName = "Lieutenant Pragg" },
	{ nOpponentId = 105, nCreatureId = 26161, nDifficulty = 3, strName = "High Priest Rain-Caller" },
	{ nOpponentId = 106, nCreatureId = 26027, nDifficulty = 3, strName = "Prime Executive" },
}
CardsData.tOpponentsByDifficulty = {}
CardsData.tOpponentsById = {}

-----------------------------------------------------------------------------------------------
-- CardsData functions.
-----------------------------------------------------------------------------------------------

function CardsData.Initialise()
	-- Categorise cards by quality to facilitate easier picking later on (e.g. choosing a random epic card).
	for iIndex, tCard in pairs(CardsData.karCards) do
		if tCard.nQualityID then
			if not CardsData.tCardsByQuality[tCard.nQualityID] then
				CardsData.tCardsByQuality[tCard.nQualityID] = {}
			end
			table.insert(CardsData.tCardsByQuality[tCard.nQualityID], tCard)
		end
	end

	-- Categorise opponents by difficulty (allows simple selection of e.g. a random difficulty 3 opponent).
	for iIndex, tOpponent in pairs(CardsData.karOpponents) do
		if tOpponent.nDifficulty then
			if not CardsData.tOpponentsByDifficulty[tOpponent.nDifficulty] then
				CardsData.tOpponentsByDifficulty[tOpponent.nDifficulty] = {}
			end
			table.insert(CardsData.tOpponentsByDifficulty[tOpponent.nDifficulty], tOpponent)
		end
	end
	-- Categorise opponents by ID.
	for iIndex, tOpponent in pairs(CardsData.karOpponents) do
		CardsData.tOpponentsById[tOpponent.nOpponentId] = tOpponent
	end
end
